                            ...
                            <div class="media-link clearfix">
								...
								<div class="media-link clearfix">
                                  <div class="link-button">
                            							<a class="btn-buy-token btn-round btn-gradient" href="result.php">Result of voting</a>
    ...
    <section class="section-3" id="scroll-section3">
        <div class="wrapper">
            <div class="container">
                ...
                <div>
                    <div>
                        <div class="col-md-3 col-xs-12   wow bounceInDown" data-wow-delay="0.2s">
                            <div class="block">
                                <div class="row">
                                    <div class="col-md-8 col-xs-3 text-center">
                                        <div class="icon">
                                            <img src="src/images/subham.jpg" class="img-responsive img-circle" alt="" />
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-xs-9">
                                        <div class="title">Shubham Bagthaliya</div>
                                        <a  href="https://www.facebook.com/subham.bagthaliya/"> <i class="fa fa-facebook-square" aria-hidden="true" style="font-size:30px;color:white"></i></a>
                                        <a  href="https://www.instagram.com/auspicious_1711/"> <i class="fa fa-instagram" aria-hidden="true" style="font-size:30px;color:white"></i></a>
                                        <a  href="https://www.instagram.com/auspicious_1711/"> <i class="fa fa-linkdin-square" aria-hidden="true" style="font-size:30px;color:white"></i></a>
                        ...
                        <div class="col-md-3 col-xs-12   wow bounceInDown" data-wow-delay="0.2s">
                            <div class="block">
                                <div class="row">
                                    <div class="col-md-8 col-xs-3 text-center">
                                        <div class="icon">
                                            <img src="src/images/raj.jpg" class="img-responsive img-circle" alt="" />
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-xs-9">
                                        <div class="title">Raj Vamja</div>
                        ...
                        <div class="col-md-3 col-xs-12  wow bounceInDown" data-wow-delay="0.6s">                         
                            <div class="block">
                                <div class="row">
                                     <div class="col-md-8 col-xs-3 text-center">
                                        <div class="icon">
                                            <img src="src/images/dhvanil.jpg" class="img-responsive img-circle" alt="" />
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-xs-9">
                                        <div class="title">Dhvanil Dudhagra</div>
                                        <a  href="https://www.facebook.com/Dhvanil Dudhagra/"> <i class="fa fa-facebook-square" aria-hidden="true" style="font-size:30px;color:white"></i></a>
                                        <a  href="https://www.instagram.com/dhvanil dudhagra/"> <i class="fa fa-instagram" aria-hidden="true" style="font-size:30px;color:white"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 col-xs-12  wow bounceInDown" data-wow-delay="0.8s">
                            <div class="block">
                                <div class="row">
                                    <div class="col-md-8 col-xs-3 text-center">
                                        <div class="icon">
                                            <img src="src/images/yas.jpg" class="img-responsive img-circle" alt="" />
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-xs-9">
                                        <div class="title">Yash Baldha</div>
                                        <a href="https://www.facebook.com/subham.bagthaliya/"><i class="fa fa-facebook-square" style="font-size:30px;color:white"></i></a>
                                        <a  href="https://www.instagram.com/shubh_1711/"> <i class="fa fa-instagram" aria-hidden="true" style="font-size:30px;color:white"></i></a>
                                     </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-xs-12">
                                    <div class="contact-address">
										<p>Email :shubhambagthaliya017@gmail.com</p>
										<p>PH : +91 9106896173</p>
									</div>
                                </div>
								<div class="col-md-6 col-xs-12">
                                   <form>
